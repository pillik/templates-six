<!-- </section> -->
<link rel="stylesheet" href="{$WEB_ROOT}/templates/{$template}/custompages/css/vasstyle.css">
<!-- <section id="main-body"> -->
<div class="landing-page mail-services">
<div class="hero">
<div class="container">
<h2>Email Security, Built for You</h2>
<h3>Never lose an email. Archive your emails. Take back control of your inbox.</h3>
</div>
</div>
...
<br><br>
    <h3>Incoming E-Mail Scanning R26/month</h3>
    <h3>Outgoing E-Mail Scanning R26/month</h3>
<h3>Incoming and Outgoing E-Mail Scanning R52/month</h3>
<h3>Incoming, Outgoing E-Mail Scanning and Archiving (10GB) R119/month</h3>
<br><br>
<h4>The SpamExperts services are only avaialable on our cPanel hosting and can be added as an Addon  in the shopping cart. This is the link to the cpanel hostings. <a href="https://www.sadomain.co.za/web-hosting.php" title="SpamExperts hosting packages">SpamExperts hosting packages</a></h4>
</div>
</div>
</div>    
